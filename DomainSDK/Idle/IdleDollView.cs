...
{
    /// <summary>
    /// 가진 인형 하나가 화면에 보이는 모습 (TASK-WM-406).
    /// </summary>
    public readonly struct IdleDollView
    {
        public IdleDollView(int id, string name, IdleDollGrade grade, IdleDollAxis axis, int sides,
