...
//
// [빨강-확인] 창이 세 번 만에 포기하게 하니 2건 빨강 — 「40초를 기다려도 안 돌아왔다」 (2026-08-14)
//
// ★ 이 관문이 세우자마자 <b>더 큰 고장</b>을 잡았다 (WM-300 → 301): 지연 없는 회선(같은 기계)에서
//   창이 「붙었다」면서도 세계가 텅 비어 보였다. 첫 전체 그림이 첫 프레임 전에 델타에 덮여
//   통째로 지나갔기 때문이다. 고친 뒤 이 관문을 CI 에 걸었다.
