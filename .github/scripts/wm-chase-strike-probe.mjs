#!/usr/bin/env node
// wm-chase-strike-probe.mjs — <b>달아나는 사람을 쫓으며</b> 때릴 때도 공평한가 (TASK-WM-405).
//
// ⚠ <b>아직 관문이 아니다</b>(그래서 이름이 -probe 다): 지금 빨강이고, 게다가 이 무대는 <b>봇</b>이라
//   창이 남의 걸음을 앞질러 그리는 것(WM-405 고침 ③)을 안 탄다. 진짜 창으로 다시 세워야 한다.
//
