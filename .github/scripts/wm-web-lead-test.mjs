...
// [문턱-사유] (a) 같은 판의 <b>유실 없는 같은 지연</b>과의 견줌 — 기계가 느리면 둘 다 같이 커진다.
//   ⚠ 배수를 2.0 에서 2.5 로 넓힌다 (2026-08-14 CI 실측 2.15배): 느린 기계에서는 다시 보내기가
//   더 크게 튄다 — 그건 제품이 아니라 기계 몫이다(관문 규율 ④-2). 잡으려는 것은 <b>폭주</b>이고,
//   폭주는 배가 아니라 몇 배다(그래서 2.5 로도 그 자리는 그대로 잡힌다).
check('유실이 섞여도 앞섬이 지연만 있는 회선과 비슷하다', lossy.worst <= usual.worst * 2.5,
