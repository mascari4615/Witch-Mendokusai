...
// ⚠ <b>빨강을 아직 못 걸었다</b> (TASK-WM-404, 2026-08-14 다시 시도): 되감기를 <b>끈</b> 세계로
//   250ms·500ms 에서 각각 두 판씩 돌렸는데 94·96·97·104·107% 로 <b>다 초록</b>이었다.
//   까닭을 알았다: 때리는 이는 <b>제 화면이 닿는다고 할 때만</b> 휘두르므로, 회선이 늦으면
//   <b>휘두르는 때</b>가 밀릴 뿐 헛치지는 않는다. 게다가 표적이 <b>앞뒤로</b> 오가서 제자리로 돌아온다.
//   되감기가 값을 하는 자리는 <b>한쪽으로 달아나는</b> 표적일 것이다 — 그 무대는 아직 안 만들었다.
//   그때까지 이 자는 <b>파수꾼</b>이다(빚 목록에 남는다 — 관문 규율 ⑥·⑦).
//
