...
//
// [빨강-확인] 고치기 <b>전</b> 코드가 이 관문에서 실제로 빨갰다 (2026-08-14): 수요를 선 위의 양으로
//   재고 0.8배로 좁히자 「나이가 안 불어난다」 빨강(0.30 → 0.68초) · 0.5배 1.45초 · 0.2배 1.78초.
//   고친 뒤(TASK-WM-339 — 작게 보내기) 0.18 → 0.33초로 초록. 아래는 거기까지 온 기록이다.
//
// ⚠ (지난 기록) 자를 고치기 전에는 세 번을 시도해도 빨강을 못 봤다: 「밀린 창을 건너뛰기」를 꺼도 초록이었다(나이 0.13초).
