...
//
// 실측 2026-08-14 (이 기계, 손으로 `WM_WINDOWS` 를 올려 가며):
//   창 3개 — 받은 판 468/466/455 · 공평 97% · 보이는 사람 38/24/24 · 초당 프레임 24/24/24
//   창 <b>6개</b> — 받은 판 420/272/331/349/347/446 · 공평 61% · 보이는 사람 24 씩 · 초당 프레임 15 씩
//   ⇒ 창이 둘 배로 늘어도 <b>굶는 창은 안 생긴다</b>(공평 바닥 50% 위). 떨어지는 건 그 기계의 프레임이다.
//   CI 기본은 3 으로 둔다 — 러너는 코어가 둘이라 여섯 창은 <b>기계 이야기</b>가 된다.
//
...
if (failures === 0) {
	console.log(`[crowd-windows] ✅ 창 ${WINDOWS}개가 무리 한복판에서도 고르게 논다`);
	process.exit(0);
}
