#!/usr/bin/env node
// wm-buddy-next-to-me-probe.mjs — <b>바로 옆 사람</b>이 무리 때문에 안 보이나 (진단용 자, TASK-WM-397).
//
...
//
// 고쳐 봤다가 <b>되돌렸다</b>: 「사람마다 제 옆 넷을 얹기」로 하니 움직임이 40번 왔지만,
//   광장(400명 한자리)에서 나가는 바이트가 <b>83MB → 530MB</b> 로 터졌다(6.4배) — 반쪽 고침이다.
//   근본은 <b>몰린 칸을 쪼개는 것</b>이다(칸을 반으로 줄여 다시 나눠 쓰기).
//
