...
namespace WitchMendokusai.ServerTests
{
	...
	/// </summary>
	/// ⏱ 관찰(2026-08-10, 미확정): 창을 <b>인사 없이</b> 끊은 두 시험만 각각 30초쯤 걸린다
	///   (Dispose 든 Abort 든 같다). 나머지 둘은 0.5초다. 서버가 끊긴 연결의 수신을 놓는 데
	///   그만큼 걸리는 것으로 보이는데, 그렇다면 <b>실제 서버도 종료가 그만큼 지연된다</b>는 뜻이라
	///   시험 속도 문제로만 볼 일이 아니다. 아직 계측으로 확정하지 않았다 — 후속.
