namespace WitchMendokusai
{
	...
	// Slice 2C-1 SOManager · 2C-2 PlayerProvider · 2C-3 DataManager (GameStat/DungeonStat Bridge 흡수).
	...
	public class CriteriaContext
	{
		...
		public CriteriaContext(SOManager soManager, PlayerProvider playerProvider, DataManager dataManager)
		{
			SOManager = soManager;
