namespace WitchMendokusai
{
	...
	// 확장 지점: 후속 Slice 에서 DataManager 추가 (GameStat/DungeonStat Bridge 흡수). Slice 2C-2 = PlayerProvider.
	...
	public class CriteriaContext
	{
		...
		public CriteriaContext(SOManager soManager, PlayerProvider playerProvider)
		{
			SOManager = soManager;
