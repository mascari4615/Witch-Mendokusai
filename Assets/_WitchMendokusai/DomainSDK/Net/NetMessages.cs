...
namespace WitchMendokusai.Net
{
	...
	public static class NetMessageType
	{
		...
		/// </summary>
		/// <summary>
		/// 창 → 서버: <b>나 여기 있고, 방금 이 도장까지 봤다</b> (TASK-WM-339).
		///
		/// ★ 왜: 세계는 창이 얼마나 밀렸는지 알아야 <b>덜 보낼</b> 수 있다. 그런데 그 앎은 지금까지
		///   창이 <b>뭔가 할 때만</b> 왔다(걸음·때리기에 얹힌 도장). 가만히 서서 구경만 하는 창은
		///   아무 도장도 안 보내므로, 세계는 그 창이 몇 초 밀려 있어도 모른다.
		/// </summary>
