...
namespace WitchMendokusai.Net
{
	...
	///
	/// ★ 이 파일이 <b>Versus 폴더</b>에 있는 이유 (2026-08-17): 처음엔 Net 폴더에 뒀는데, 그러면
	///   「Net 이 대결 스탯을 알고, 대결이 Net 의 말을 안다」가 되어 두 어셈블리가 서로를 참조한다 —
	///   유니티는 그 순환을 거부한다. 대결에서만 쓰는 말은 <b>대결의 것</b>이다.
	///   이름칸(namespace)은 그대로 두어 「말의 모양은 한 자리」라는 규약을 지킨다.
	///
