...
namespace WitchMendokusai
{
	...
	public sealed class IdleHealthBar : MonoBehaviour
	{
		...
		public static IdleHealthBar Attach(Transform owner, float height, float width, float thickness,
			Color backColor, Color fillColor)
		{
			...
			IdleHealthBar bar = root.AddComponent<IdleHealthBar>();
