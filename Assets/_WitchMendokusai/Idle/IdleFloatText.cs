...
{
	/// <summary>
	/// 튀어오르는 숫자 (TASK-WM-406).
	///
	/// ★ 왜 필요한가 (사용자 실측 2026-08-16: 「전혀 클리커 같지 않다」):
	...
	/// </summary>
	public sealed class IdleFloatText
	{
		...
		public IdleFloatText(VisualElement host)
		{
			for (int one = 0; one < POOL; one++)
			{
				Label label = new Label(string.Empty);
				label.AddToClassList("idle-float");
