...
namespace WitchMendokusai.Idle.Editor
{
	...
	///
	/// 배치: Unity -batchmode -quit -executeMethod WitchMendokusai.Idle.Editor.IdlePlayerBuild.Build
	...
	public static class IdlePlayerBuild
	{
		...
		/// ★ 배치: Unity -batchmode -quit -executeMethod WitchMendokusai.Idle.Editor.IdlePlayerBuild.BuildAndroid
